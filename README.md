...
**资金角色**：本系统的选股、TrendOK、红绿灯仓位等交易规则，针对的是家庭资产中的**卫星仓**（用于博取更高收益的一部分资金）。房产、宽基/债券 ETF、现金等**核心仓**在系统外配置；信号再强也不等于全家 all-in。详见 [docs/modules/README.md](./docs/modules/README.md)「投资理念」。
