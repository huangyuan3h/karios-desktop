...
meta(
  ...
  meta(
    ...
    'indexMacro',
    '核心腿 ETF 日线（双子星）',
    '增量同步双子星核心腿 5 只 ETF（金/油/纳×2/债）日线——mom60/MA200 决策依赖；修复原每月一次 cron 导致 GOLD/BOND10 停更 7+ 天的缺陷。',
    '工作日 17:25',
    '25 17 * * 1-5',
    'cron',
    true,
  ...
  meta(
    ...
    'indexMacro',
    '个股估值（市值）',
    '增量同步 stock_dailybasic（total_mv / circ_mv / turnover_rate）——双子星 (Twin-Star) 卫星 S-gap 低波候选的每日市值依赖；2026-08-07 起曾停更，本任务补齐并每日维护。',
    '工作日 17:20',
    '20 17 * * 1-5',
    'cron',
    true,
  ...
  meta(
    ...
    'watchlistAutomation',
    '双子星 14:30 前提醒',
    '工作日 14:20 计算双子星 (Twin-Star) 今日操作信号：核心择强目标 + S-gap 卫星 R-wide 闸/低波候选，webhook + 通知中心推送，供 14:30 前调整。',
    '工作日 14:20',
    null,
    'cron',
    true,
