...
export const SCHEDULER_JOB_CATALOG: readonly SchedulerJobMeta[] = [
  ...
  meta(
    ...
    'indexMacro',
    '核心腿 ETF 日线（港湾）',
    '增量同步港湾核心腿 5 只 ETF（金/油/纳×2/债）日线——mom60/MA200 决策依赖；修复原每月一次 cron 导致 GOLD/BOND10 停更 7+ 天的缺陷。',
    '工作日 17:25',
    '25 17 * * 1-5',
    'cron',
    true,
  ...
  meta(
    ...
    'indexMacro',
    '个股估值（市值）',
    '增量同步 stock_dailybasic（total_mv / circ_mv / turnover_rate）——港湾 S-3 核心选股的每日市值依赖；2026-08-07 起曾停更，本任务补齐并每日维护。',
    '工作日 17:20',
    '20 17 * * 1-5',
    'cron',
    true,
  ...
  meta(
    ...
    'cnBasic',
    'A 股尾盘 5 分钟线',
    '工作日 18:40 用 baostock 拉取当日 14:30–15:00 的 5 分钟 K（缺口票 + 开仓 CN）。一年历史走 backfill_bar_5min.py。',
    '工作日 18:40',
    '40 18 * * 1-5',
    'cron',
    true,
  ...
  meta(
    ...
    'factors',
    '雪球关注度快照',
    '工作日 15:40 抓取雪球全市场关注数横截面落库 cn_xq_follow（P0-13 散户关注度）。无历史接口，只能向前每日积累，攒够再开诊断。',
    '工作日 15:40',
    '40 15 * * 1-5',
    'cron',
    true,
