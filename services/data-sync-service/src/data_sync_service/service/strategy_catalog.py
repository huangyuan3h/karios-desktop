...
_STRATEGIES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "cons": ["valid 窗相对母港 −4.9pt、踩线（K1 余量 0.1pt；稳健区间 0.15–0.25）", "依赖卫星执行（未过审计）；holdout 描述弱"],
    },
    {
        "key": "starship",
        "name": "星舰",
        ...
        "pros": ["long +463.6%/SR 3.50/MDD −8.4%，年度全正、与核心低相关", "fills 已校验 1036/1036 落在日线区间"],
        "cons": [
            "执行审计未过（成本敏感/独立复现/容量均未做）",
