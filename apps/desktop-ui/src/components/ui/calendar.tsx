  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: cn(
          'absolute inset-0 appearance-none bg-transparent opacity-0',
          defaultClassNames.dropdown,
        ),
        dropdown_root: cn(
          'relative rounded-md border border-[var(--k-border)]',
          defaultClassNames.dropdown_root,
        ),
        nav: cn(
          'absolute top-0 inset-x-0 flex h-9 w-full items-center justify-between',
