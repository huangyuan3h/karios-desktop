...
>
> **重要补充**：本文档只覆盖 **DB 单维度**。系统级痛点（**换电脑也能跑 / 长期有生命力 / 远程访问**）见 [`karios-longevity-2026-08.md`](./karios-longevity-2026-08.md)。**用户原话（2026-08-01 review）**："我关心的无非换电脑也能正常跑这个系统，让这个系统长期有生命力，远程也能访问这几个痛点。"
