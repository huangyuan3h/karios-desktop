...
> `docs/modules/backtest-strategy.md`（2026-08-09 归档，现行参数真值见 `strategy-params.md`）；作战计划见归档快照 [`2026-08-27-todo-full-snapshot.md`](../archive/2026-08-27-todo-full-snapshot.md) §19。
