...
> **Timeline 图口径（2026-09-09 起 · OPT-152）**：双子星 Timeline 主曲线 = **实盘口径**（STOCK 日按 S-3 实际权益——真实仓位/成本/闸门，CN+HK 50/50 联合；ETF/REPO 按择强硬切；卫星占用日 50/50 切仓），100% 押注基准 = 灰虚线对照。上段 +194.9 等冻结定数仍是基准口径历史档。HK 冻结口径同日起含 T+2（strategy-params §1b）。见 `optimization-checklist/archive/2026-09-09-opt-152-timeline-product-curve.md`。
