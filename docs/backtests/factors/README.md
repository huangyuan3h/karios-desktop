...
>
> **状态：价量公式因子部分已完结（2026-09-12）。** Alpha101 / GTJA191 / HK 对照三组：统计有微弱信号、成本后归零、无新独立轴。归档 [`../../archive/2026-09-12-factor-library-screens.md`](../../archive/2026-09-12-factor-library-screens.md)。
...
| **HK（H 股）对照** | [hk-alpha101-gtja191-l0-2026-09-12](hk-alpha101-gtja191-l0-2026-09-12.md) | ❌ **REJECT** | 269 条：0 PASS / 15 CANDIDATE / 252 REJECT；**同一价量家族复现但更差**——HK 弱市年 IC≈0（A 股 +0.05）、成本更高（40bp 印花税双边）→ 净更负。说明该结论**非 A 股特有**，但 A 股信号最强、HK 最不可交易。 |
