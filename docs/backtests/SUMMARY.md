...
| P0-13 ETF 停车场确立为 S-3 新基线「港湾」（Harbor · 2026-09-13 · 只读） | 闲置即停（14:30 卫星口径、收盘代理、含 0.05%/边成本、三窗+long）；`eval_etf_parking_baseline` | **P1 PASS → 新基线「港湾」（Harbor, tag `harbor-p1-20260913`）= S-3 + 停车场**：三窗 **+15.5/+11.0/+11.6**、long **+125.4**（K1/K2/K3 全过；2026-09-13 修复：幻影日 + Live 决策单源，对账 **100%（473/473）**）；V0 三窗 = 官方基线 ✅。**Live overlay 代价**：20% 地板≈0；**ETF>STOCK mom 门槛 long +20.8 vs +90.0（−69pt）→ 应去掉**。**风险**：valid MDD −9.4→**−23.1**、Sharpe 2.44→1.91（S-3 空仓时停车场=满仓 ETF + trail 出场无冷却次日再进）；long MDD −23.6 vs −28.1、Sharpe 0.83 vs 0.64 | 见 [etf-parking-baseline-2026-09-13](stable/etf-parking-baseline-2026-09-13.md) |
| P0-13 习惯双子星重拟合·停车场核心（2026-09-13 · 只读） | 停车场核心 + Live 卫星（strict clip4 same_1430）→ `blend_nav_opportunity(0.5)`；`eval_twin_star_parking` | **REJECT（K1/K2/K3 全 FAIL）**：50/50 双子星 vs 停车场核心 OOS2 **+36.5/+1.14sr/回撤改善**，train **−11.8/−0.16**，valid **−28.8/−0.84**，long **−55.6/−0.13 且回撤 −23.6→−48.3**；40/60、60/40 全不过。**根因**：卫星 standalone 年度 **2022 −34.8% / 2023 −48.0%**、long MDD **−80.6%**（boom-bust）；旧 clip4 三窗恰是其 2024 +164.7%/2025 +77.4% 黄金段 + 含前视核心腿 → 旧"50/50 用很少收益换 Sharpe/回撤"**双失真、不再成立**。卫星不可在现有配方上调参重扫；要救须带全周期门槛另起预注册。**下一步 B1 ETF 买持基准 → 对停车场基线（不含卫星）跑** | 见 [twin-star-parking-refit-2026-09-13](stable/twin-star-parking-refit-2026-09-13.md) |
| P0-13 ETF 买持基准 × 多方法拟合（2026-09-13 · 只读） | 停车场基线 vs 10 只 ETF / 等权/风险预算/60-40/择时/套筒/两个 50/50 混合；`eval_etf_benchmark_parking` | **基线收益全面胜出**（四窗 total 全高于所有单只与被动组合；事后最强单只仅 train 黄金 +49.7 反超，valid/long 输）。**风险上被动组合更强**：风险预算 long Sharpe 1.71/MDD −5.0（基线 0.83/−23.6）。**最佳拟合 = 基线×风险预算 50/50**：四窗 Sharpe 全升（1.53/2.92/2.07/1.01）、MDD 全面减半（−9.2/−5.3/−11.8/−12.2），代价=收益（long +114 vs +184）。**510050/588000 已在 `etf_daily.csv` → 旧数据缺口作废**。50/50 落地需另起预注册 | 见 [etf-benchmark-parking-2026-09-13](stable/etf-benchmark-parking-2026-09-13.md) |
| P0-13 停车场再入场冷却（H-PARK-C · 2026-09-13 · 只读 · 预注册） | 同 B11 P1 口径 + trail8 出场后同 key 冷却 k∈{1,2,3,5}（次优候选/REPO）× 三窗+long；`eval_parking_cooldown` | **REJECT（四档全挂 K1/K2/K4/K5）**：k0 与 B11 逐数一致（+62.0/+45.3/+50.3/+219.9）；冷却档 valid **−6.8~−13.4pt**、long k1 **−22.9pt**，valid MDD 最好仅 +2.4pt（门槛 3pt）、Sharpe 四档全降（−0.18~−0.41）、换手反增（21→26/27）。**主死因 #1 截右尾**（挡住急跌后 V 反抽）+ #4 regime；k5 long +5.0 单窗假象。**方向关闭，P1（k=0）维持** | 见 [parking-cooldown-2026-09-13](stable/parking-cooldown-2026-09-13.md) |
| P0-13 「母港」（Homeport = 港湾 × 风险预算 50/50 · H-MIX · 2026-09-13 · 预注册） | 主动腿港湾（B11 P1）+ 被动腿 B3（300/500/金/纳/债 逆波动率月度）月初再平衡 50/50（5bp/边）× 三窗+long + 2022–23 压测 + 20bp 成本敏感性；`eval_harbor_riskbudget` | **PASS（K1–K5 全过）→ 产品候选（不进 Live）**：四窗 Sharpe **1.99/3.32/2.26/1.23**（vs 港湾 1.84/2.76/2.14/1.05）、MDD **−9.0/−5.2/−11.4/−12.2**（vs −14.3/−8.4/−21.8/−23.4）、long **+122.5**（vs +219.9）；压测 0.62/−8.3 vs 0.57/−15.9；B13 日频零成本复刻 ≈ 月频含成本（long +124.4 vs +122.5）。**代价=收益近半（买保险）**；落地需用户拍板资本结构 + paper 3/20 | 见 [harbor-riskbudget-2026-09-13](stable/harbor-riskbudget-2026-09-13.md) |
| P0-13 B3 单资产权重上限（H-B3-CAP · 2026-09-13 · 预注册） | 逆波动率权重 cap∈{50%,60%} 水填 × 独立腿 + 母港 M50 嵌入 × 三窗+long+压测；`eval_b3_cap` | **REJECT**：cap50 独立 long CAGR 8.2→9.7 但 **Sharpe 1.76→1.41**、MDD −4.7→−7.1（cap60 1.55 更差）；母港层 cap50 近中性（+129.6 vs +122.5、Sharpe 1.23 持平）。**#4 regime 命中**（2021–26 债是最高 Sharpe 资产，capsize 是正解）；incumbent 维持 | 见 [b3-cap-2026-09-13](stable/b3-cap-2026-09-13.md) |
| P0-13 母港市况开关（H-MIX-DYN · 2026-09-13 · 预注册） | 沪深300×MA200(t-1)：强市 100% 港湾 / 弱市 50/50；四窗+压测；`eval_homeport_regime` | **REJECT（K2/K3/K6 挂）**：long CAGR **24.7**（> M50 18.0）但 Sharpe **1.08 < 1.23**、MDD **−20.6**；2022–23 压测 **0.20/−10.5** vs M50 0.62/−8.3；valid 强市 +42.8 但 MDD −21.7。"进攻 100/0"能实现，"防守"不比静态好；方向关闭，静态 M50 维持 | 见 [homeport-regime-2026-09-13](stable/homeport-regime-2026-09-13.md) |
