...
## 4b. Addendum 2026-09-21：成本严格化重跑 + 正式复活（用户拍板）

> **决定（用户 2026-09-21）**：双子星**整体复活为五档正式并行档**（catalog `status=product_candidate`/`statusLabel=并行 · 正式`/`roleLabel=均衡`），不再只是"并行对照"徽章；展示/研究口径，Live 仍 = 港湾。§1–§4 的 09-14 数字保留为冻结快照。

**新成本重跑（CN 静态 30→32.28bp + 1-tick 滑点下限；脚本同 §0，报告 JSON 已覆盖）**：

| 窗口 | 停车场核心 | 卫星 standalone | **双子星 50/50** | Δcore total |
|---|---|---|---|---|
| OOS2 | +54.4 / 57.2 / −14.3 / 1.71 | +207.2 / 221.8 / −4.4 / 6.38 | **+144.6 / 153.8 / −9.2 / 4.22** | +90.2 |
| train | +52.0 / 137.5 / −8.2 / 3.00 | +36.2 / 89.3 / −8.6 / 3.05 | **+52.2 / 138.0 / −6.6 / 3.93** | +0.2 |
| valid | +50.2 / 156.1 / −21.8 / 2.13 | +6.5 / 15.7 / −7.3 / 0.91 | **+24.5 / 66.1 / −21.8 / 1.31** | −25.7 |
| long | +197.1 / 25.3 / −22.9 / 0.98 | +468.3 / 43.4 / −5.1 / 3.45 | **+299.8 / 33.3 / −20.8 / 1.48** | +102.7 |

- **成本影响**：dev 窗 −1.3/−0.4/−0.3（long +7.9，属数据漂移非成本）。
- **裁决不变**：valid Δcore −25.7（卫星趋势窗有仓仅 27%）→ 原生 K1/K2 仍挂；作为**展示并行档**保留，**不进 Live**（Live 策略变更须另起预注册）。
- 五档横向对比见 [`five-strategy-v2-scorecard-2026-09-16.md`](five-strategy-v2-scorecard-2026-09-16.md) §9。
