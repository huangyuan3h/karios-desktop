...
## 跨市场对照：HK（H 股）
- **方法**：同一套 Alpha101+GTJA191 引擎跑 `.HK`（原始价、无行业/市值、成本 40bp、基准 HSI）。
- **结果**：269 条 **0 PASS / 15 CANDIDATE / 252 REJECT**；唯一活的仍是**同一价量相关家族**，但 HK 弱市年 IC≈0（A 股 +0.05）、成本更高 → 净更负。
- **判定**：❌ REJECT。**结论非 A 股特有，但 A 股信号最强、HK 最不可交易。** US/加拿大无仓库数据、未测。源：[`hk-alpha101-gtja191-l0-2026-09-12.md`](../backtests/factors/hk-alpha101-gtja191-l0-2026-09-12.md)。
